...
namespace MedicalStore.Business.Mappings
{
    public class MappingProfile : Profile
    {
        public MappingProfile()
        {
            ...
            CreateMap<MedicineCategoryVM, MedicineCategory>()
                .ForMember(
                    dest => dest.CatId,
            ...
            CreateMap<Brand, BrandDetailsVM>()
                .ForMember(
                    ...
                    opt => opt.Ignore())
                .ForMember(
                    dest => dest.ModifiedDateFormatted,
                    opt => opt.Ignore())
                .ForMember(
                    dest => dest.Status,
                    opt => opt.Ignore())
                .ForMember(
                    dest => dest.MedicineCount,
                    opt => opt.Ignore())
                .ForMember(
                    dest => dest.TotalStockValue,
                    opt => opt.Ignore());
            ...
            CreateMap<MedicineMaster, MedicineMasterVM>()
                .ForMember(
                    dest => dest.MedicineId,
                    opt => opt.MapFrom(src => src.MedId))
                .ForMember(
                    dest => dest.CategoryName,
                    opt => opt.MapFrom(src =>
                        src.Category != null
            ...
            CreateMap<MedicineMasterVM, MedicineMaster>()
                .ForMember(
                    dest => dest.MedId,
                    opt => opt.MapFrom(src => src.MedicineId))
                .ForMember(
                    dest => dest.CreatedDate,
                    opt => opt.Ignore())
                .ForMember(
            ...
            CreateMap<Customer, CustomerVM>()
                .ForMember(
                    ...
                    opt => opt.MapFrom(src => src.CustId))
                .ForMember(
                    dest => dest.CustomerName,
                    opt => opt.MapFrom(src => src.CustName));
            ...
            CreateMap<PurchaseMaster, PurchaseMasterVM>()
                .ForMember(
                    dest => dest.PurId,
                    opt => opt.MapFrom(src => src.PurchaseId))
                .ForMember(
                    dest => dest.PurchaseDate,
                    opt => opt.MapFrom(src => src.PurchaseDate))
                .ForMember(
                    dest => dest.SuppId,
                    opt => opt.MapFrom(src => src.SuppId))
                .ForMember(
                    dest => dest.SupplierName,
                    opt => opt.MapFrom(src =>
                        src.Supplier != null
                ...
                .ForMember(
                    dest => dest.InvoiceNo,
                    opt => opt.MapFrom(src => src.InvoiceNo))
                .ForMember(
                ...
                .ForMember(
                    dest => dest.NetTotal,
                    opt => opt.MapFrom(src => src.NetTotal))
                .ForMember(
                    dest => dest.PurchaseDetails,
                    opt => opt.Ignore());
            ...
            CreateMap<PurchaseDetails, PurchaseDetailVM>()
                ...
                .ForMember(
                    dest => dest.Amt,
                    opt => opt.MapFrom(src => src.Amt))
                .ForMember(
                    dest => dest.GstPct,
                    opt => opt.MapFrom(src => src.GstPct))
                .ForMember(
                    dest => dest.GstAmt,
                    opt => opt.MapFrom(src => src.GstAmt))
                .ForMember(
                    dest => dest.Total,
            ...
            CreateMap<SaleMaster, SaleMasterVM>()
                ...
                .ForMember(
                    dest => dest.SaleId,
                    opt => opt.MapFrom(src => src.SaleId));
            ...
            CreateMap<SaleDetails, SaleDetailVM>()
                ...
                .ForMember(
                    dest => dest.SaleDetId,
                    opt => opt.MapFrom(src => src.SaleDetId));
